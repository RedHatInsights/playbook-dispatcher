...
generate-inventory:
	# TODO: Inventory's recent spec change broke our generation, using a shipped version for now (https://github.com/RedHatInsights/insights-host-inventory/commit/7c10243d80eb8f4ce52eb50a84a1c030094c230c)
