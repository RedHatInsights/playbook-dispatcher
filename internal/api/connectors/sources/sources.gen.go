...
// Valid indicates whether the value is a known member of the RhcConnectionReadAvailabilityStatus enum.
func (e RhcConnectionReadAvailabilityStatus) Valid() bool {
	switch e {
	case RhcConnectionReadAvailabilityStatusAvailable:
		return true
	case RhcConnectionReadAvailabilityStatusInProgress:
		return true
	case RhcConnectionReadAvailabilityStatusPartiallyAvailable:
		return true
	case RhcConnectionReadAvailabilityStatusUnavailable:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the SourceAppCreationWorkflow enum.
func (e SourceAppCreationWorkflow) Valid() bool {
	switch e {
...
// Valid indicates whether the value is a known member of the SourceAvailabilityStatus enum.
func (e SourceAvailabilityStatus) Valid() bool {
	switch e {
	case SourceAvailabilityStatusAvailable:
		return true
	case SourceAvailabilityStatusInProgress:
		return true
	case SourceAvailabilityStatusPartiallyAvailable:
		return true
	case SourceAvailabilityStatusUnavailable:
		return true
	default:
		return false
	}
...
// Resource_ID defines model for ID.
...
type ClientInterface interface {
	...
	GetSourcesRhcConnection(ctx context.Context, resourceID Resource_ID, params *GetSourcesRhcConnectionParams, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) GetSourcesRhcConnection(ctx context.Context, resourceID Resource_ID, params *GetSourcesRhcConnectionParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetSourcesRhcConnectionRequest(c.Server, resourceID, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewGetSourcesRhcConnectionRequest(server string, resourceID Resource_ID, params *GetSourcesRhcConnectionParams) (*http.Request, error) {
	var err error

	var pathParam0 string

	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "id", resourceID, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
...
type ClientWithResponsesInterface interface {
	...
	GetSourcesRhcConnectionWithResponse(ctx context.Context, resourceID Resource_ID, params *GetSourcesRhcConnectionParams, reqEditors ...RequestEditorFn) (*GetSourcesRhcConnectionResponse, error)
}
...
func (c *ClientWithResponses) GetSourcesRhcConnectionWithResponse(ctx context.Context, resourceID Resource_ID, params *GetSourcesRhcConnectionParams, reqEditors ...RequestEditorFn) (*GetSourcesRhcConnectionResponse, error) {
	rsp, err := c.GetSourcesRhcConnection(ctx, resourceID, params, reqEditors...)
	if err != nil {
		return nil, err
	}
