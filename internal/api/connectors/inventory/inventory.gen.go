...
type CanonicalFactsOut struct {
	...
	ExternalProviderId *External_ProviderId `json:"provider_id"`
	...
	ExternalProviderType *External_ProviderType `json:"provider_type"`
