...
const (
	...
	ApiRunsListParamsSortByEmpty         ApiRunsListParamsSortBy = ""
)
...
func (e ApiRunsListParamsSortBy) Valid() bool {
	...
	case ApiRunsListParamsSortByCreatedAtDesc:
		return true
	case ApiRunsListParamsSortByEmpty:
		return true
	default:
		return false
	}
...
type ApiRunHostsListParams struct {
	...
	Fields *RunHostFields `form:"fields,omitempty" json:"fields,omitempty"`
...
type ApiRunsListParams struct {
	...
	// Fields Defines fields to be returned in the response.
	Fields *RunsFields `form:"fields,omitempty" json:"fields,omitempty"`
